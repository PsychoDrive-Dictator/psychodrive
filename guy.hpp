...
private:
    ...
    bool MatchChargeCommandInput(Charge *pCharge, uint32_t &cursorPos, uint32_t maxSearch, uint32_t initialI);
    ...
    bool normalGrabbedThisFrame : 1;
    bool hitStunGrabbedThisFrame : 1;
    bool grabAdjust : 1;
    bool hitThisMove : 1;
