...
int main(int, char**)
{
    ...
    std::string movesDictText = readFile("/home/live/src/psychodrive/honda_dict.json");
    auto movesDictJson = nlohmann::json::parse(movesDictText);

    std::string rectsText = readFile("/home/live/src/psychodrive/honda_rects.json");
    auto rectsJson = nlohmann::json::parse(rectsText);

    std::string namesText = readFile("/home/live/src/psychodrive/honda_names.json");
    auto namesJson = nlohmann::json::parse(namesText);

    std::string triggerGroupsText = readFile("/home/live/src/psychodrive/honda_trigger_groups.json");
    auto triggerGroupsJson = nlohmann::json::parse(triggerGroupsText);

    std::string triggersText = readFile("/home/live/src/psychodrive/honda_triggers.json");
